...
// The line above enabels type checking for this file. Various IDE interpret the
// @ts-check directive. It will give you helpful autocompletion when 
...
export function costOf( sign, currency ) {
    ...
    let cost = signLength + ( basePrice * letterPrice ) - 5;
    currency = cost.toFixed( 2 );

    return `Your sign costs ${currency} dollars.`;
